...
def setup_langchain():
    # Load Excel data
    df = pd.read_excel(r"C:\Users\Admin\Downloads\extracted_job_d.xlsx")  # Adjust the path as necessary
    ...
    embeddings = GoogleGenerativeAIEmbeddings(
        ...
        google_api_key='AIzaSyDuPBbp8To3hJRVp4IXIZheAxLe4i4GcKo',  # Replace with your API key
